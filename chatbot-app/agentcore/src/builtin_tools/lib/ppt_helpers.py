...
utility functions for PowerPoint manipulation.

Key Functions:
- select_layout: Smart layout selection based on content type
- populate_slide: Fill slide with content
- analyze_template: Extract layouts and structure from PPT
- TextSizeCalculator: Calculate optimal text sizes

Note: Slides are created using custom python-pptx code for full design control.
"""
